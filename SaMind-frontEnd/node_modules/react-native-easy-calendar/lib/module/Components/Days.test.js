...
dayjs.extend(localizedFormat); // import { DayComponentType } from '../Entities';
...
class DaysPage {
  constructor({
    ...
    const {
      getByTestId,
      queryAllByTestId
    } = render( /*#__PURE__*/React.createElement(ThemeContext.Provider, {
      value: theme
