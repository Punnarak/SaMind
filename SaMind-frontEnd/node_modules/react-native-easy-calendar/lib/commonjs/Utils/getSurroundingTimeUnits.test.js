...
var _getSurroundingTimeUnits = _interopRequireDefault(require("./getSurroundingTimeUnits"));
...
describe('Surrounding months', () => {
  describe('works for months surrouding Febuary', () => {
    test('January', () => {
      const {
        month
      } = (0, _getSurroundingTimeUnits.default)('2020-01-25');
    ...
    test('March', () => {
      const {
        month
      } = (0, _getSurroundingTimeUnits.default)('2020-03-25');
  ...
  test('works for end-of-month visible date', () => {
    const {
      month
    } = (0, _getSurroundingTimeUnits.default)('2020-07-31');
  ...
  test('works for start-of-month visible date', () => {
    const {
      month
    } = (0, _getSurroundingTimeUnits.default)('2020-07-01');
    expect(month.last.format('YYYY-MM-DD')).toEqual('2020-06-30');
    expect(month.next.format('YYYY-MM-DD')).toEqual('2020-08-01');
  });
  test('works for end-of-year visible dates', () => {
    const {
      month
    } = (0, _getSurroundingTimeUnits.default)('2020-12-31');
  ...
  test('works for start-of-year visible dates', () => {
    const {
      month
    } = (0, _getSurroundingTimeUnits.default)('2020-01-01');
    expect(month.last.format('YYYY-MM-DD')).toEqual('2019-12-31');
    expect(month.next.format('YYYY-MM-DD')).toEqual('2020-02-01');
  });
});
...
//# sourceMappingURL=getSurroundingTimeUnits.test.js.map